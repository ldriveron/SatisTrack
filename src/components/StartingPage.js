		...
		<div className="home">
			...
			<div className="section">
				<div className="explainer">
					<h2>Keep tack of your mood at the end of the work day.</h2>
					<p>
					...
					<img className="streak_screenshot" src="Screenshots/Streak_Notifier.png" />
				</div>
				<img className="small_screenshot" src="Screenshots/Dashboard_Small.png" />
			</div>
			...
			<div className="section">
				...
				<img className="large_screenshot" src="Screenshots/Dashboard_Large.png" />
			</div>
		</div>
	);
};
